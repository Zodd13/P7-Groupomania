	...
	methods: {
		...
		submitPostImage() {
			...
			if (formData.get("image") === "" && formData.get("message") === "") {
				...
				this.messageError =
					"Votre devez nous partager au moins une photo et un message !";
			} else {
...
<svg data-v-5f19e91b="" class="p-3" xmlns="http://www.w3.org/2000/svg" width="auto" height="78" viewBox="0 0 485 78">
    <!---->
    <!---->
    <!---->
    <g data-v-5f19e91b="" id="35fa3215-a46c-2dc7-0ca7-44149903aade" fill="rgb(194, 89, 93)" transform="matrix(4.569687698175228,0,0,4.569687698175228,96.32992012448554,-2.2310693714669583)">
    ...
    <g data-v-5f19e91b="" id="c3a0a99d-5b99-a49f-d46f-4168a2d07e26" transform="matrix(0.9288891262478298,0,0,0.9288891262478298,183.17781124538936,-199.52452538383787)" stroke="none" fill="rgb(194, 89, 93)">
        <switch>
            <g>
	...
	<div class="main--container">
		...
		<div v-if="!validated" class="mt-2">
			<h5 class="mt-3" v-if="this.post.message === ''">
